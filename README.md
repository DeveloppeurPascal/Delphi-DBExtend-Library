...
Delphi is a development environment that lets you program in Pascal and is supported by a lot of integrated tools, from design to deployment of projects for Windows, macOS, iOS, Android and Linux.

This project contains units and components that extend the functionality of Delphi's standard database components.

It can also be used to run Delphi in no-code mode, either on its own or in conjunction with other [no-code component libraries for Delphi](https://github.com/DeveloppeurPascal/Delphi-NoCode-Library).

This project is a complement to existing database component frameworks in Delphi or its ecosystem.

It currently targets dbExpress and FireDAC, but can be extended to ADO, UniDAC and others if the need arises.
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Delphi-DBExtend-Library).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Delphi-DBExtend-Library) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://dbextend.developpeur-pascal.fr/) or [the project devlog](https://developpeur-pascal.fr/bdd.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Delphi-DBExtend-Library/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://dbextend.developpeur-pascal.fr/).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Delphi-DBExtend-Library) and [open a new issue](https://github.com/DeveloppeurPascal/Delphi-DBExtend-Library/issues).
